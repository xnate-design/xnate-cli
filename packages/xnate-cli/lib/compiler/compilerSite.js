...
var COMPONENT_DOCS_RE = /\/([-\w]+)\/([-\w]+)\/docs\/([-\w]+)\.md/;
...
var getComponentsDocPath = function (path) {
  var _a;
  var _b = __read((_a = path.match(COMPONENT_DOCS_RE)) !== null && _a !== void 0 ? _a : [], 4),
    category = _b[1],
    routePath = _b[2],
    language = _b[3];
  return '/'.concat(language, '/').concat(category, '/').concat(routePath);
};
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            (0, fs_1.glob)(''.concat(constant_1.ROOT_PAGES_DIR, '/**/').concat(constant_1.LOCALE_DIR_NAME, '/*.ts')),
          ];
        case 2:
          baseLocales = _a.sent();
          return [
        ...
        case 3:
          ...
          baseLocales.forEach(function (locale) {
            ...
            map.set(
              routePath + language,
              (0, slash_1.default)(
                ''.concat(constant_1.ROOT_PAGES_DIR, '/').concat(routePath, '/locale/').concat(language, '.ts'),
              ),
            );
          });
