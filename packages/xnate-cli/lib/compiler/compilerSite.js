...
var HOME_LOCALE_RE = /\/docs\/home\/\/locale\/([-\w]+)\.ts/;
var EXAMPLE_COMPONENT_NAME_RE = /\/([-\w]+)\/example\/index.tsx/;
var getRootDocPath = function (path) {
    var _a;
    var _b = __read((_a = path.match(ROOT_DOCS_RE)) !== null && _a !== void 0 ? _a : [], 4), type = _b[1], routePath = _b[2], language = _b[3];
    return "/".concat(language, "/").concat(type, "/").concat(routePath);
};
var getComponentsDocPath = function (path) {
    var _a;
    var _b = __read((_a = path.match(COMPONENT_DOCS_RE)) !== null && _a !== void 0 ? _a : [], 3), routePath = _b[1], language = _b[2];
...
var getExamples = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, (0, fs_1.glob)("".concat(constant_1.SRC_DIR_COMPONENTS, "/**/").concat(constant_1.EXAMPLE_DIR_NAME, "/").concat(constant_1.DIR_INDEX))];
    });
}); };
var getComponentsDocs = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, (0, fs_1.glob)("".concat(constant_1.SRC_DIR_COMPONENTS, "/**/").concat(constant_1.DOCS_DIR_NAME, "/*.md"))];
    });
}); };
var getRootDocs = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
...
var getRootRouteDoc = function () {
    ...
    var routeMap = navs.filter(function (n) { return n.index; }).map(function (m) { return m.path; });
    var configRoute = [];
...
var getRootLocales = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                userPages = _a.sent();
                return [4 /*yield*/, (0, fs_1.glob)("".concat(constant_1.ROOT_PAGES_DIR, "/**/").concat(constant_1.LOCALE_DIR_NAME, "/*.ts"))];
            case 2:
                baseLocales = _a.sent();
                return [4 /*yield*/, userPages.reduce(function (userLocales, page) { return __awaiter(void 0, void 0, void 0, function () {
                        var locales;
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, (0, fs_1.glob)("".concat(page, "/").concat(constant_1.LOCALE_DIR_NAME, "/*.ts"))];
                                case 1:
                                    locales = _b.sent();
                                    if (!locales.length)
            ...
            case 3:
                ...
                baseLocales.forEach(function (locale) {
                    ...
                    map.set(routePath + language, (0, slash_1.default)("".concat(constant_1.ROOT_PAGES_DIR, "/").concat(routePath, "/locale/").concat(language, ".ts")));
                });
...
var compileMobileSiteRoutes = function () { return __awaiter(void 0, void 0, void 0, function () {
    var examples, routes, source;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getExamples()];
            case 1:
                examples = _a.sent();
...
var compilePcSiteRoutes = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, componentsDocs, rootDoc, rootLocales, rootPagesRoutes, rootDocsRoutes, componentDocsRoutes, rootRouteDoc, rootRouteDocsZh, rootRouteDocsEn, source;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = __read.apply(void 0, [_b.sent(), 3]), componentsDocs = _a[0], rootDoc = _a[1], rootLocales = _a[2];
                rootPagesRoutes = rootLocales.map(function (rootLocale) { return "\n  {\n    path: '".concat((0, exports.getRootRoutePath)(rootLocale), "',\n    // @ts-ignore\n    component: () => import('").concat((0, exports.getRootFilePath)(rootLocale), "')\n  }"); });
                rootDocsRoutes = rootDoc.map(function (doc) { return "\n  {\n    path: '".concat(getRootDocPath(doc), "',\n    // @ts-ignore\n    component: () => import('").concat(doc, "')\n  }"); });
                componentDocsRoutes = componentsDocs.map(function (doc) { return "\n  {\n    path: '".concat(getComponentsDocPath(doc), "',\n    // @ts-ignore\n    component: () => import('").concat(doc, "')\n  }"); });
                rootRouteDoc = getRootRouteDoc();
                rootRouteDocsZh = rootRouteDoc.map(function (doc) { return "\n  {\n    path: '/zh-CN".concat(doc.path, "',\n    redirect: '/zh-CN").concat(doc.redirect, "',\n  }"); });
                rootRouteDocsEn = rootRouteDoc.map(function (doc) { return "\n  {\n    path: '/en-US".concat(doc.path, "',\n    redirect: '/en-US").concat(doc.redirect, "',\n  }"); });
                source = "export default [    ".concat(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], __read(rootPagesRoutes), false), __read(rootDocsRoutes), false), __read(componentDocsRoutes), false), __read(rootRouteDocsZh), false), __read(rootRouteDocsEn), false), ",\n]");
