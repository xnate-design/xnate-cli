...
var initCli = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_b.label) {
            case 0:
                ...
                if (!semver_1.default.satisfies(process.version, pkgVersion, { includePrerelease: true })) {
                    logger_1.logger.error("you are using Node ".concat(process.version, ", xnate-cli need is a node version above ").concat(pkgVersion));
                    process.exit(1);
                }
