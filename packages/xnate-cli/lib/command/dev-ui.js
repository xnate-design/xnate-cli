        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    logger_1.logger.info("".concat(isRestart ? 'Res' : 'S', "tarting server..."));
                    _a = server;
                ...
                case 7:
                    ...
                    if ((0, fs_extra_1.pathExistsSync)(constant_1.XNATE_CONFIG)) {
                        ...
                        watchers.on('change', function () { return startServer(force); });
                    }
                    logger_1.logger.info("".concat(isRestart ? 'Res' : 'S', "tart successfully!!!"));
                    return [2 /*return*/];
            }
        });
    });
